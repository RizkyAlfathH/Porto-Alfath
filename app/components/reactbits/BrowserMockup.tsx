 ...
 * thumbnail project yang belum ada screenshot-nya. Tab bar warna-warni
 * "berdenyut" bergantian, bar chart mini "tumbuh" naik-turun, dan ada
 * cursor yang melayang pelan — biar tetep hidup walau cuma ilustrasi.
 */
export default function BrowserMockup() {
  return (
    <div className="flex h-full w-full items-center justify-center bg-elevated p-6">
      <div className="w-full max-w-xs rounded-xl border border-line bg-bg shadow-xl">
        ...
        <div className="p-4">
          ...
          <div className="flex gap-4">
            ...
            {/* Mini bar chart, tumbuh naik-turun pelan */}
